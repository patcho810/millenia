...
export const ALGORITHM_REGISTRY: AlgorithmDef[] = [
  ...
  {
    id: 'hsl-shift', stageId: 'preprocess', label: 'HSL Shift',
    defaultParams: {
      hsl_r_hue: 0, hsl_r_sat: 0, hsl_r_lum: 0,
      hsl_y_hue: 0, hsl_y_sat: 0, hsl_y_lum: 0,
      hsl_g_hue: 0, hsl_g_sat: 0, hsl_g_lum: 0,
      hsl_c_hue: 0, hsl_c_sat: 0, hsl_c_lum: 0,
      hsl_b_hue: 0, hsl_b_sat: 0, hsl_b_lum: 0,
      hsl_m_hue: 0, hsl_m_sat: 0, hsl_m_lum: 0,
    },
    paramDefs: [
      { key: 'hsl_r_hue', label: 'Hue R°', type: 'range', min: -60, max: 60, step: 1, default: 0 },
      { key: 'hsl_r_sat', label: 'Sat R', type: 'range', min: -1, max: 1, step: 0.05, default: 0 },
      { key: 'hsl_r_lum', label: 'Lum R', type: 'range', min: -50, max: 50, step: 1, default: 0 },
      { key: 'hsl_y_hue', label: 'Hue Y°', type: 'range', min: -60, max: 60, step: 1, default: 0 },
      { key: 'hsl_y_sat', label: 'Sat Y', type: 'range', min: -1, max: 1, step: 0.05, default: 0 },
      { key: 'hsl_y_lum', label: 'Lum Y', type: 'range', min: -50, max: 50, step: 1, default: 0 },
      { key: 'hsl_g_hue', label: 'Hue G°', type: 'range', min: -60, max: 60, step: 1, default: 0 },
      { key: 'hsl_g_sat', label: 'Sat G', type: 'range', min: -1, max: 1, step: 0.05, default: 0 },
      { key: 'hsl_g_lum', label: 'Lum G', type: 'range', min: -50, max: 50, step: 1, default: 0 },
      { key: 'hsl_c_hue', label: 'Hue C°', type: 'range', min: -60, max: 60, step: 1, default: 0 },
      { key: 'hsl_c_sat', label: 'Sat C', type: 'range', min: -1, max: 1, step: 0.05, default: 0 },
      { key: 'hsl_c_lum', label: 'Lum C', type: 'range', min: -50, max: 50, step: 1, default: 0 },
      { key: 'hsl_b_hue', label: 'Hue B°', type: 'range', min: -60, max: 60, step: 1, default: 0 },
      { key: 'hsl_b_sat', label: 'Sat B', type: 'range', min: -1, max: 1, step: 0.05, default: 0 },
      { key: 'hsl_b_lum', label: 'Lum B', type: 'range', min: -50, max: 50, step: 1, default: 0 },
      { key: 'hsl_m_hue', label: 'Hue M°', type: 'range', min: -60, max: 60, step: 1, default: 0 },
      { key: 'hsl_m_sat', label: 'Sat M', type: 'range', min: -1, max: 1, step: 0.05, default: 0 },
      { key: 'hsl_m_lum', label: 'Lum M', type: 'range', min: -50, max: 50, step: 1, default: 0 },
    ],
  },
